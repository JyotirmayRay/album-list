...
export default class App extends Component {
  ...
  // When the app renders, this function is called for the first time.
  ...
  /* This function, deleteAlbum, takes an album ID from the albums list.
  It then removes the album from the albums list and updates the state. */
  ...
  /* This function updates album functions.
  It takes an album object from the albums list and sets the state for updating the album. */
  ...
  setUpdateAlbum = async (album) => {
   ...
   // This function takes album id, updateTitle, updateUserid, oldAlbum, and then updates and sets the state.
  updateAlbumInList = async (id, updateTitle, updateUserid, oldAlbum) => {
   ...
   //this function takes input for userid and title, and adds it to the end of the albums list
